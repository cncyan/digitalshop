...
<body>
    ...
    <div class="operation_user clearfix">
        ...
        <div class="link fr">
            <b>欢迎您，<?php echo $_SESSION["adminName"];?></b>&nbsp;&nbsp;&nbsp;<a href="#" class="icon icon_i">首页</a><span></span><a href="#" class="icon icon_j">前进</a><span></span><a href="#" class="icon icon_t">后退</a><span></span><a href="#" class="icon icon_n">刷新</a><span></span><a href="#" class="icon icon_e">退出</a>
        </div>
    </div>
