...
<div class="userPosition comWidth">
	...
	<span>&nbsp;&gt;&nbsp;</span>
	<a href="#"><?php echo $pro['cname'];?></a>
	<span>&nbsp;&gt;&nbsp;</span>
	<em><?php echo $pro['psn'];?></em>
</div>
		...
		<div class="leftArea">
			<div class="description_imgs">
				...
				<ul class="des_smimg clearfix">
					<li><a href="#"><img src="img/des_sm.jpg" class="active" alt=""></a></li>
					<li><a href="#"><img src="img/des_sm2.jpg" alt=""></a></li>
					<li><a href="#"><img src="img/des_sm.jpg" alt=""></a></li>
					<li><a href="#"><img src="img/des_sm2.jpg" alt=""></a></li>
					<li><a href="#"><img src="img/des_sm.jpg" alt=""></a></li>
				</ul>
			</div>
		...
		<div class="rightArea">
			<div class="des_content">
				...
				<div class="dl clearfix">
					...
					<div class="dd clearfix"><span class="des_money"><em>￥</em><?php echo $pro['cprice'];?></span></div>
				</div>
				<div class="dl clearfix">
					<div class="dt">优惠</div>
	...
	<div class="rightArea">
		<div class="des_infoContent">
			...
			<div class="info_text">
				...
				<p>现在就是买mini的好时候！换代清仓直降，但苹果品质不变！A5双核，内置Lightning闪电接口，正反可插，方便人性。小身材，炫丽的7.9英寸显示屏，7.2mm的厚度，薄如铅笔。女生包包随身携带更时尚！facetime视频通话，与密友24小时畅聊不断线。微信倾力打造，你的智能助理。苹果的牌子就不用我说了，1111补仓，存货不多哦！</p>
				<div class="hr_45"></div>
				<img src="img/pad.jpg" class="center">
				<div class="hr_45"></div>
			</div>
		</div>
		<div class="hr_15"></div>
